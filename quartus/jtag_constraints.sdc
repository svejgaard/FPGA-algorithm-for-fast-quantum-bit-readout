# This file is downloaded from here: https://community.intel.com/t5/FPGA-Wiki/JTAG-Constraints-file-in-Timing-Analyzer-Cookbook-MNL-010135/ta-p/735135
# Following the text in the Timing Analyzer Cookbook
# https://www.intel.com/content/dam/www/programmable/us/en/pdfs/literature/manual/mnl_timequest_cookbook.pdf
# Eample 21: JTAG Signal Constraints
# all changes to the default file are highlighted by a comment "CHANGED"
...
proc set_tdi_timing_spec_when_driven_by_device { } {
    ...
    set tdi_in_min [expr $previous_device_tdo_tco_min + $tdi_trace_min -0 [get_tck_delay_max]]
